# Memer Breaker [![](https://goreportcard.com/badge/github.com/MemerBreaker/MemerBreaker)](https://goreportcard.com/report/github.com/MemerBreaker/MemerBreaker) ![](https://img.shields.io/github/license/MemerBreaker/MemerBreaker) [![](https://img.shields.io/github/v/release/MemerBreaker/MemerBreaker)](https://github.com/MemerBreaker/MemerBreaker/releases/latest) ![](https://img.shields.io/github/downloads/MemerBreaker/MemerBreaker/total)

[Join Our Community Server!](https://discord.gg/Uwky7sNzGZ) & [Join Our Suppport Discord!](https://discord.gg/JsGyaT9Ecg)
Have any questions? [Create A Question Issue](https://github.com/MemerBreaker/MemerBreaker/issues/new?assignees=&labels=question&template=question.md&title=). Want Want to suggest a feature? [Create a suggestion issue](https://github.com/MemerBreaker/MemerBreaker/issues/new?assignees=&labels=suggestion&template=suggestion.md&title=)
Encountering a bug? [Report A Bug](https://github.com/MemerBreaker/MemerBreaker/issues/new?assignees=&labels=bug&template=bug-report.md&title=)
Wish to contribute? [Please Read Our Contribution Guidelines](https://github.com/MemerBreaker/MemerBreaker/blob/master/CONTRIBUTING.md).
